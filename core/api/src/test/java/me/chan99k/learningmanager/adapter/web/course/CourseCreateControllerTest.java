...
import me.chan99k.learningmanager.web.course.CourseCreateController;
		...
		given(courseCreationService.createCourse(any(CourseCreation.Request.class)))
			.willThrow(
				new AuthorizationException(
					me.chan99k.learningmanager.domain.exception.AuthProblemCode.AUTHORIZATION_REQUIRED));
	...
	void createCourse_failure_unauthenticated() throws Exception {
		...
		given(courseCreationService.createCourse(any(CourseCreation.Request.class)))
			.willThrow(new AuthenticationException(
				me.chan99k.learningmanager.domain.exception.AuthProblemCode.AUTHENTICATION_CONTEXT_NOT_FOUND));
