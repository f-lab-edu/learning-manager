...
public enum SessionProblemCode implements ProblemCode {
	...
	ROOT_SESSION_SELF_LEAVE_NOT_ALLOWED("DLS027", "[System] 루트 세션에서는 자가 탈퇴가 불가능합니다. 관리자에게 문의하세요."),

	// Access control related
	NOT_SESSION_HOST("DLS100", "[System] 세션 호스트만 이 작업을 수행할 수 있습니다."),
	NOT_SESSION_PARTICIPANT("DLS101", "[System] 세션 참가자만 이 작업을 수행할 수 있습니다.");
